...
enum class WeatherCondition(
    ...
    CLEAR_DAY("Clear sky", R.drawable.ic_widget_weather_clear_day, labelResId = R.string.condition_clear_sky),
    CLEAR_NIGHT("Clear sky", R.drawable.ic_widget_weather_clear_night, true, labelResId = R.string.condition_clear_sky),
    MAINLY_CLEAR_DAY("Mainly clear", R.drawable.ic_widget_weather_partly_cloudy_day, labelResId = R.string.condition_mainly_clear),
    MAINLY_CLEAR_NIGHT("Mainly clear", R.drawable.ic_widget_weather_partly_cloudy_night, true, labelResId = R.string.condition_mainly_clear),
    PARTLY_CLOUDY_DAY("Partly cloudy", R.drawable.ic_widget_weather_partly_cloudy_day, labelResId = R.string.condition_partly_cloudy),
    PARTLY_CLOUDY_NIGHT("Partly cloudy", R.drawable.ic_widget_weather_partly_cloudy_night, true, labelResId = R.string.condition_partly_cloudy),
    OVERCAST("Overcast", R.drawable.ic_widget_weather_cloudy, labelResId = R.string.condition_overcast),
    FOG("Fog", R.drawable.ic_widget_weather_fog, labelResId = R.string.condition_fog),
    DEPOSITING_RIME_FOG("Depositing rime fog", R.drawable.ic_widget_weather_fog, labelResId = R.string.condition_rime_fog),
    DRIZZLE_LIGHT("Light drizzle", R.drawable.ic_widget_weather_drizzle, labelResId = R.string.condition_drizzle_light),
    DRIZZLE_MODERATE("Moderate drizzle", R.drawable.ic_widget_weather_drizzle, labelResId = R.string.condition_drizzle_moderate),
    DRIZZLE_DENSE("Dense drizzle", R.drawable.ic_widget_weather_drizzle, labelResId = R.string.condition_drizzle_dense),
    FREEZING_DRIZZLE_LIGHT("Light freezing drizzle", R.drawable.ic_widget_weather_drizzle, labelResId = R.string.condition_freezing_drizzle_light),
    FREEZING_DRIZZLE_HEAVY("Heavy freezing drizzle", R.drawable.ic_widget_weather_drizzle, labelResId = R.string.condition_freezing_drizzle_dense),
    RAIN_SLIGHT("Slight rain", R.drawable.ic_widget_weather_rain, labelResId = R.string.condition_rain_slight),
    RAIN_MODERATE("Moderate rain", R.drawable.ic_widget_weather_rain, labelResId = R.string.condition_rain_moderate),
    RAIN_HEAVY("Heavy rain", R.drawable.ic_widget_weather_rain, labelResId = R.string.condition_rain_heavy),
    FREEZING_RAIN_LIGHT("Light freezing rain", R.drawable.ic_widget_weather_rain, labelResId = R.string.condition_freezing_rain_light),
    FREEZING_RAIN_HEAVY("Heavy freezing rain", R.drawable.ic_widget_weather_rain, labelResId = R.string.condition_freezing_rain_heavy),
    SNOW_SLIGHT("Slight snowfall", R.drawable.ic_widget_weather_snow, labelResId = R.string.condition_snow_slight),
    SNOW_MODERATE("Moderate snowfall", R.drawable.ic_widget_weather_snow, labelResId = R.string.condition_snow_moderate),
    SNOW_HEAVY("Heavy snowfall", R.drawable.ic_widget_weather_snow, labelResId = R.string.condition_snow_heavy),
    SNOW_GRAINS("Snow grains", R.drawable.ic_widget_weather_snow, labelResId = R.string.condition_snow_grains),
    RAIN_SHOWER_SLIGHT("Slight rain shower", R.drawable.ic_widget_weather_rain, labelResId = R.string.condition_rain_showers_slight),
    RAIN_SHOWER_MODERATE("Moderate rain shower", R.drawable.ic_widget_weather_rain, labelResId = R.string.condition_rain_showers_moderate),
    RAIN_SHOWER_VIOLENT("Violent rain shower", R.drawable.ic_widget_weather_rain, labelResId = R.string.condition_rain_showers_violent),
    SNOW_SHOWER_SLIGHT("Slight snow shower", R.drawable.ic_widget_weather_snow, labelResId = R.string.condition_snow_showers_slight),
    SNOW_SHOWER_HEAVY("Heavy snow shower", R.drawable.ic_widget_weather_snow, labelResId = R.string.condition_snow_showers_heavy),
    THUNDERSTORM("Thunderstorm", R.drawable.ic_widget_weather_thunderstorm, labelResId = R.string.condition_thunderstorm),
    THUNDERSTORM_SLIGHT_HAIL("Thunderstorm with slight hail", R.drawable.ic_widget_weather_thunderstorm, labelResId = R.string.condition_thunderstorm_hail),
    THUNDERSTORM_HEAVY_HAIL("Thunderstorm with heavy hail", R.drawable.ic_widget_weather_thunderstorm, labelResId = R.string.condition_thunderstorm_hail_heavy),
    UNKNOWN("Unknown", R.drawable.ic_widget_weather_clear_day, labelResId = R.string.condition_clear_sky);
